...
public class StripeProcessor extends AuditablePaymentProcessor {
    ...
    public PaymentResponse process(PaymentRequest request) {
        if(request == null ) throw new ApiException("PayPalProcessor.StripeKey", "La key está vacía");
        if(stripeKey == null || stripeKey.isBlank())  throw new ApiException("StripeProcessor.Request", "La request es null");
